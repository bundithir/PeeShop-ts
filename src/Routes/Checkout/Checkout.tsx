import { AddtoCart, DeleteItemfromCart, RemovefromCart , Items , ResetCart} from '../../Store/cart/cart-reducer';
import { SelectcartItems, TotalSelect } from "../../Store/cart/cart-selector";
import { useAppDispatch , useAppSelector } from "../../Store/hook";
import { DeleteIcon } from './checkout-icon';
import { Button } from './checkout-style';
...
const Checkout = () =>{
    ...
    return(
        <div className="w-[80%] mx-auto">
            ...
            <button className='flex justify-center p-5 bg-black text-white items-center mx-auto w-[200px] font-bold rounded-lg hover:opacity-50' onClick={Pay}>PAY</button>
        </div>
    )
}
